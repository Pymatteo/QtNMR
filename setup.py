...
includes = ['sys','PyQt5.QtCore','PyQt5.QtGui', 'PyQt5.QtWidgets','matplotlib', 'numpy', 'platform', 'struct', 'modules', 'os','re','copy','scipy.fftpack','io','glob','PyQt5.QtSvg','zmq.backend.cython','pygments.lexers.agile','pygments.styles.default','zmq.utils.garbage']
excludes = []
packages = []
path = []
base = None
